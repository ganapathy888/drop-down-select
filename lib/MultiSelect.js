...
var _CountBadge = require("./CountBadge");
...
var MultiSelect = function (_Component) {
  ...
  _createClass(MultiSelect, [{
    ...
    value: function handleOptionClick(newValue, index, isChecked) {
      this.input.focus();
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_CountBadge2.default, { selectCount: this.state.values.length }),
