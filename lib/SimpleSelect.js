...
var SimpleSelect = function (_Component) {
  ...
  _createClass(SimpleSelect, [{
    ...
    value: function _handleOptionChange(option, index) {
      ...
      if (onChange) {
        var value = returnValueOnly ? option[valueKey] : option;
    ...
    key: '_loadProps',
    value: function _loadProps(_ref) {
      ...
      if (value != undefined) {
        var inputValue = '';
        if (value && labelKey) {
          inputValue = (typeof value === 'undefined' ? 'undefined' : _typeof(value)) == 'object' ? value[labelKey] : this._findLabelByValue(options, value);
        } else {
          inputValue = value;
        }
    ...
    value: function _findLabelByValue(options, value) {
      var _this2 = this;

      var index = options.findIndex(function (option) {
        return option[_this2.props.valueKey].toLowerCase() == value.toLowerCase();
      });
    ...
    value: function renderOptionsContainer() {
      ...
      var _state4 = this.state,
          ...
          currentOptions = _state4.currentOptions;
